...
watershed_attrs = {
    'description': 'watersheds in the south fork salmon river subbasin',
    '1': 'confluence',
    '2': 'johnson creek',
    '3': 'lower east fork south fork salmon river',
    '4': 'lower south fork salmon river',
    '5': 'secesh river',
    '6': 'upper east fork south fork salmon river',
    '7': 'upper south fork salmon river'
}